...
- [x] 띠별 운세, 연애운, 재물운, 취업/시험운, 건강운
- [x] 켈틱 크로스 타로, 말발굽 타로, 생명의 나무 타로, 보름달 타로
- [x] 생일 숫자 운세 (수비학)
- [x] 연애 궁합, 이름 궁합, 띠 궁합, 사업 파트너 궁합
- [ ] 토정비결, 오라클 카드, 룬 문자

### **Phase 4 — 소셜 기능** 🚧

- [x] Firebase 인증 (Google / GitHub 로그인)
- [x] 결과 저장 / 마이페이지
- [ ] 공유 피드
- [ ] 인스타그램 스토리 이미지 생성
...
> ✅ 완료 (20개) · 📋 예정 (13개) · 난이도: ⭐ 쉬움 · ⭐⭐ 중급 · ⭐⭐⭐ 고급 · ⭐⭐⭐⭐ 최고급
