...
**카드/도구 점술 (8종):** 타로 원카드, 3장 스프레드, 켈틱 크로스, 말발굽 타로, 생명의 나무 타로, 보름달 타로, 오라클 카드, 룬 문자  
**AI 맞춤 운세 (5종):** 꿈해몽, 연애운, 재물운, 취업/시험운, 건강운  
**궁합/관계 (4종):** 연애 궁합, 이름 궁합, 띠 궁합, 사업 파트너 궁합  
**관상/신체 (1종):** 성명학  

**준비 중 (9종):** 자미두수, 출생 차트, 육효점, 기문둔갑, 주역 괘, 산가지 점, 이사/방위 길흉, AI 관상, AI 수상
