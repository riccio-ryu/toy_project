            ...
            <div className="relative w-[110px] h-[190px]">
              {[0, 1, 2, 3, 4].map((i) => (
                <motion.div
                  ...
                  style={{ zIndex: i }}
                  animate={{
                    x: [0, i % 2 === 0 ? -40 : 40, 0, i % 2 === 0 ? 28 : -28, 0],
        ...
        {phase === "spread" && (
          ...
          >
            <div className="flex items-center justify-between">
              <p className="text-white/60 text-sm">원하는 카드 3장을 선택하세요</p>
            ...
            <div className="relative">
              <div className="absolute left-0 top-0 bottom-4 w-8 bg-gradient-to-r from-black/50 to-transparent z-10 pointer-events-none rounded-l-xl" />
              <div className="absolute right-0 top-0 bottom-4 w-8 bg-gradient-to-l from-black/50 to-transparent z-10 pointer-events-none rounded-r-xl" />
              ...
              <div className="overflow-x-auto pb-2 -mx-4 px-4 scrollbar-none">
                <div className="flex gap-2" style={{ width: "max-content" }}>
                  {spreadCards.map((card, i) => {
                    ...
                    const rotation = (i - SPREAD_COUNT / 2) * 1.0;
                    ...
                    return (
                      <motion.div
                        ...
                        className="cursor-pointer shrink-0 flex flex-col items-center"
                      >
                        <div
                          className={`rounded-xl transition-all duration-200 ${
                            isSelected
                              ? "ring-2 ring-purple-400 shadow-lg shadow-purple-500/60"
                              : "hover:ring-1 hover:ring-white/20"
                          }`}
                        >
                          <TarotCard cardId={card.card.id} isRevealed={false} size="sm" />
                        </div>
                        <div className="h-5 mt-1 flex items-center justify-center">
                          {isSelected && (
                            <motion.span
                              ...
                              className="text-[10px] text-purple-300 bg-purple-900/60 px-1.5 py-0.5 rounded-full"
                            >
                              {selOrder + 1}
                            </motion.span>
                          )}
